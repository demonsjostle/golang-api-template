...
func (uu *UserUpdate) AddUserPermissionIDs(ids ...int) *UserUpdate {
...
func (uu *UserUpdate) RemoveUserPermissionIDs(ids ...int) *UserUpdate {
...
// AddUserPermissionIDs adds the "user_permissions" edge to the UserPermission entity by IDs.
func (uuo *UserUpdateOne) AddUserPermissionIDs(ids ...int) *UserUpdateOne {
...
// RemoveUserPermissionIDs removes the "user_permissions" edge to UserPermission entities by IDs.
func (uuo *UserUpdateOne) RemoveUserPermissionIDs(ids ...int) *UserUpdateOne {
