...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Permission, c.Role, c.RolePermission, c.User, c.UserPermission, c.UserRole,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		Permission, Role, RolePermission, User, UserPermission, UserRole []ent.Hook
	}
	inters struct {
